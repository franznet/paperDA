...
In Figure \ref{fig:da_test_msssim}, the most artificial real datasets present better diversity and testing accuracy values than the artificial datasets in the same DA method, and they are Drifting (x)(xi), rotation (ii)(iii), SpecAugment (xvii)(xviii), Drifting (viii)(ix).
