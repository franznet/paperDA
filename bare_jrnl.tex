...
generated by the data augmentation techniques, these characteristics were analysed in the different datasets, which 
does not seem to have too much impact on model performance.
\end{abstract}
