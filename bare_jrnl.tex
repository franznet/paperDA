...
Where x(t) and y(t) represent the seismic signal and short-time Fourier transform sliding window. The sliding window size was set to 1 with a 95% overlap. The spectrograms generated are images RGB of 224x224 pixels.
