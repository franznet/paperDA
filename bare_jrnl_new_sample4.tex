...
\title{Evaluating data augmentation techniques in the classification of multi-station seismic-volcanic signals}

\author{Franz~Yupanqui~Machaca\,\orcidlink{0000-0003-1149-1370}, \and Pablo~Salazar~Reinoso\,\orcidlink{0000-0002-7496-705X}, \and Claudio~Meneses~Villegas\,\orcidlink{0000-0003-1112-4925}
        % <-this % stops a space
\thanks{Franz~Yupanqui~Machaca is with the PhD Program in Sustainable Engineering, Universidad Católica del Norte, Antofagasta 1270709, Chile, with the Millennium Institute on Volcanic Risk Research – Ckelar Volcanoes, Antofagasta 1270709, Chile, and also with the 4D Perceptio, La Paz, Bolivia (e-mail: \href{mailto:frayup@gmail.com}{frayup@gmail.com}, franz.yupanqui@alumnos.ucn.cl).}
\thanks{Pablo~Salazar~Reinoso is with the Department of Geological Sciences, Universidad Católica del Norte, Antofagasta 1270709, Chile, and also with the Millennium Institute on Volcanic Risk Research – Ckelar Volcanoes, Antofagasta 1270709, Chile  (e-mail: \href{mailto:pasalaz@ucn.cl}{pasalaz@ucn.cl}).}
\thanks{Claudio~Meneses~Villegas is with the Department of Computing and Systems Engineering, Universidad Católica del Norte, Antofagasta 1270709, Chile  (e-mail: \href{mailto:cmeneses@ucn.cl}{cmeneses@ucn.cl}).}
}
...
\begin{abstract}
Effective volcano monitoring depends on quickly identifying seismic events to better grasp activity levels and issue timely warnings. Conventional approaches rely on manual analysis, which can lead to bias and demands considerable effort.
This work seeks to characterize several data augmentation techniques in terms of similarity and diversity metrics, and evaluate their impact on the performance of classification of seismic-volcanic signatures. 
These techniques are used to generate diverse datasets on which seismic-volcanic event classification models are trained, to analyze which techniques provide the best classification performance. 
A primary objective of using data augmentation is to balance the dataset, ensuring greater diversity in the event feature space, and maintaining a minimal similarity with the original data.
The generated datasets are categorized into two types: (1) balanced datasets composed of real and augmented data, and 
(2) balanced datasets composed of only augmented data. Furthermore, applying similarity and diversity metrics to the augmented data reveals that the fully augmented datasets exhibit greater diversity than the real datasets. It is also observed that several of these augmented datasets yield superior performance in the classification models. 
\end{abstract}
...
ResNet152 – TL(2022)\cite{mythesismaster} & Lascar – Chile & 13,430 & Yes & 1 & 10 & 5	& 93.2\\
AlexNet – TL Artificial(2022)\cite{mythesismaster} & Lascar – Chile & 67,095 & Yes & 1 & 10 & 5 & 98.9\\
AlexNet – TL 10-folds(2022)\cite{mythesismaster} & Lascar – Chile & 13,430 & Yes & 1 & 10 & 5 & 89.1\\
AlexNet – DL CAE3 Reconstructed Event(2022)\cite{mythesismaster} & Lascar – Chile & 13,430 & Yes & 1 & 10 & 5 & 91.2\\
AlexNet – TL Real+Artificial 20Hz(2023)\cite{salazar2022multi} & Lascar – Chile & 13,430 & Yes & 1 & 10 & 5 & 91.5\\
AlexNet – TL Artificial 20Hz(2023)\cite{salazar2022multi} & Lascar – Chile & 67,095 & Yes & 1 & 10 & 5 & 99.4\\
AlexNet – TL Artificial 20Hz, Real(Test)(2023)\cite{salazar2022multi} & Lascar – Chile & 6,145 & Yes & 1 & 10 & 5 & 99.5\\
...
\subsection{A summary of methods used in classification of volcanic seismic events}
\noindent The seismic-volcanic signals are time series that are not stationary and contain information about the physical processes occurring in the volcanic system. Magma movement, gas emissions, and rock fracturing are just a few of the sources that generate these signals. Understanding volcanic activity and assessing eruption risks requires the analysis of these signals.
In the analysis and treatment of seismic-volcanic time signals, transformations are usually applied to represent the time domain observations in terms of the frequency and cepstral domains, and using statistical and information theory metrics, among others \cite{malfante2018automatic,lara2020automatic}. Among the methods used for the analysis of this type of signal, the most common are the Hidden Markov model (HMM)\cite{bicego2012classification,beyreuther2012constructing, carniel2014characterization} with their improvements, such as the Hidden Semi-Markov Models (HSMM), the Continuous Wavelet Transform (CWT)\cite{beyreuther2012constructing} in the detection of singularities, Gaussian Mixture Model (GMM)\cite{langer2009synopsis}, and others, such as the HMM-based generative embedding \cite{bicego2012classification}. \\
...
Unsupervised methods include Kohonen Self-Organizing Map (SOM)\cite{langer2009synopsis,esposito2008unsupervised}, Cluster Analysis(CA)\cite{langer2009synopsis}, Balanced iterative reducing and clustering using hierarchies(BIRCH)\cite{duque2020exploring}. \\
...
Current research on recognizing seismic-volcanic signal patterns considers data from a single Chilean volcano. The Millennium Institute on Volcanic Risk Research – Ckelar Volcanoes\footnote{\href{https://ckelar.org}{https://ckelar.org}} monitors many of these volcanoes using seismic stations equipped with triaxial sensors.

\subsection{Lascar volcano}
\noindent The Lascar volcano is located in northern Chile (23\textdegree22' S, 67 \textdegree44' W; 5592 m a.s.l.), 270 km NE from Antofagasta and 70 km SE from San Pedro de Atacama. CKELAR-VOLCANES has been monitoring the area using a network of 11 three-component seismic stations. Short-period 2 Hz seismometers were continuously monitored at 200 Hz. A signal database was built using only the Z channel. The stations are distributed around the volcano, as shown in Figure~\ref{fig:lascar_map}. 
\begin{figure*}
  \subfloat[]{\includegraphics[width=0.27\linewidth]{img/lascar_ubicacion.jpg}
    \label{fig:lascar_location}} 
  \hfill
  \subfloat[]{\includegraphics[width=0.71\linewidth]{img/lascar_estaciones.png}
    \label{fig:lascar:estations}} 
\caption{a) Location map of Lascar volcano\cite{imgLascarWikimedia}. b) Red dots indicate the positions of the seismic stations.}
\label{fig:lascar_map}
\end{figure*}


\subsection{Lascar's database}
\noindent The Lascar database contains 6,145 seismic events classified by geophysicist experts belonging to CKELAR-VOLCANES. The data correspond to the period between March and October 2018. The tables \ref{table:lascar_database} and \ref{table:lascar_statistics} show the data distribution.
\begin{table*}
...
\begin{table*}
\caption{Statistics of the events belonging to the Lascar volcano.}
\centering
...
\noindent We proposed a solution based on transfer learning because this helps to speed up training and improve the performance of deep learning models \cite{titos2019classification,bueno2019volcano}, in addition to the limited number of examples available for training the model from scratch. For TL, the pre-trained AlexNet\cite{krizhevsky2012imagenet} model was considered.
...
\begin{enumerate}
 \item describing the pre-process applied to the time series (earthquake);
 \item detailing the generation of spectrograms from the labeled earthquakes;
 \item using data augmentation techniques to increase the amount of data in the training and test datasets;
 \item constructing the prediction model; and, finally,
 \item estimating the performance of the model.
\end{enumerate}
In the following paragraphs, each step is explained.
\begin{enumerate}
  \item Pre-processing: The seismometers record data at 200Hz, 500Hz or 100Hz. We resampled each event at 100 Hz. The data were centered at the mean. A Butterworth Highpass filter was applied at 1 Hz. Then, we applied a Butterworth Bandpass filter at frequencies between 1 Hz and 10 Hz. The next step was to normalize the data. This pre-processing task was performed using the ObsPy Python toolbox \cite{beyreuther2010obspy}.
...
where x(t) and y(t) represent the seismic signal and short-time Fourier transform sliding window, respectively. The sliding window size was set to 1 with a 95\% overlap. The generated spectrograms are RGB images of $224\times224$ pixels.
  \item Data augmentation techniques were considered to avoid unbalanced datasets and prevent biased models. Many data augmentation techniques were implemented, which are presented in the next section.
  \item The pre-trained model AlexNet\cite{krizhevsky2012imagenet} was considered for retraining over spectrograms, using the scheme of transfer learning.
  \item The model performance was evaluated using metrics described in the following sections. The metrics are implemented on the TorchMetrics Python toolbox\footnote{\href{https://lightning.ai/docs/torchmetrics/stable}{https://lightning.ai/docs/torchmetrics/stable}}.
\end{enumerate}
Codes for reproducing our method are available at.\footnote{\href{https://github.com/franznet/daseismicsignals}{https://github.com/franznet/daseismicsignals}}



\subsection{Data Similarity}
\noindent Kullback–Leibler divergence (KL divergence) has been used to measure similarities between synthetic and real datasets, and is defined as
\begin{equation}
...
d_t=d_{t-1}+\phi(\tau)
\end{equation}
where $\phi$ is the random variable describing the probability distribution for the next step, and $\tau$ is the time interval between consecutive steps. Consequently, an original time series $x={x_1,\ldots,x_t,\ldots,x_T}$ can be transformed into $x'={x_1+d_1,\ldots,x_t+d_t,\ldots,x_T+d_T}$.
Data drift simulation can be used to generate more robust training datasets, thereby enhancing model resilience and reducing sensitivity to drift when it arises in real-world data (Figure~\ref{fig:da_drifting}).
\begin{figure*}
\centering
...
\begin{itemize}
\item \textit{Without time adjustment:} The segments exchanged between parents may differ in length, resulting in a child seismogram with a duration that can vary significantly from that of the original seismograms (Figure~\ref{fig:da_ga1}).
\item \textit{With time adjustment:} The exchanged segments are rescaled to equal length by applying a time-scaling transformation, ensuring that the generated seismogram maintains a duration comparable to the original signals (Figure~\ref{fig:da_ga2}).
\end{itemize}
\begin{figure*}
\centering
...
In this work, we apply SpecAugment on the spectrograms using frequency masking, time masking, and time warping policies (Figure~\ref{fig:da_specaugment}).
\begin{figure*}
\centering
...
\noindent Machine learning metrics make it possible to quantify the performance of a trained model and to compare it with other generated models or with the current baseline. Evaluating the learning algorithm is a crucial part of any project. While classification accuracy is most commonly used to assess model performance, it is insufficient on its own to provide a complete evaluation. Therefore, various complementary evaluation metrics are considered.
Among the different classification metrics, we can mention:
\begin{itemize}
\item \textit{Confusion Matrix:} A tabular representation of true labels versus model predictions. Although not a performance metric in itself, it serves as the foundation for deriving many other evaluation measures (Table \ref{table:confusion_matrix}).
\begin{table}
...
\end{equation}
\item \textit{Cohen’s kappa:} Measures the agreement between your model and human evaluators, taking randomness into account. It is particularly useful for imbalanced datasets.
\begin{equation}
\kappa = \frac{p_0-p_e}{1-p_e}
\end{equation}

where $p_0$ is the empirical probability of agreement and $p_e$ is the expected agreement when both annotators assign labels randomly\footnote{\href{https://lightning.ai/docs/torchmetrics/stable/classification/cohen_kappa.html}{https://lightning.ai/docs/torchmetrics/stable/classification/cohen\_kappa.html}}.
\end{itemize}


\subsection{Evaluation metrics for data augmentation}
\noindent Data augmentation techniques have become a widely adopted strategy for improving the generalization capacity of deep neural networks. An important consideration in this context is the balance between similarity and diversity in the data \cite{yang2024investigating}. Similarity reflects the degree of resemblance between the original and augmented data, whereas diversity captures the variation in complexity introduced through augmentation. 
These metrics were calculated using the framework Python TorchMetrics\footnote{\href{https://lightning.ai/docs/torchmetrics/stable}{https://lightning.ai/docs/torchmetrics/stable}} de Lightning AI, the creators of PyTorch Lightning.
...
\begin{table*}
\caption{Performance of the transfer learning experiments over AlexNet pre-trained model.}
\centering
\begin{adjustbox}{width=\textwidth}
\begin{tblr}{
  row{2} = {c},  column{1} = {c}, column{3} = {c},  column{4} = {c},  column{5} = {c},
...
Dataset & Data
  augmentation & {Accuracy\\(\%)} & {F1\\(\%)} & {Recall\\(\%)} & {Precision\\(\%)} & {Cohen Kappa\\(\%)} & Class Accuracy (\%) &  &  &  & \\
 &  &  &  &  &  &  & HY & LP & TC & TR & VT\\
...
\noindent We identified an unbalanced data distribution, consisting of 3\% (HY), 9\% (LP), 36\% (TC), 8\% (TR), and 44\% (VT), as shown in Table~\ref{table:lascar_statistics}. To address this imbalance, we generated new data through various data augmentation techniques, such as Rotation, Jittering, Drifting, Scaling, Flipping, Genetic Algorithms, SpecAugment, and Interpolation. Each data augmentation technique was applied to balance the existing dataset, resulting in a dataset containing 13,430 events (2,686 examples per class). Furthermore, we created balanced datasets consisting solely of augmented data, ensuring an equal number of events, as detailed in Table~\ref{table:training_statistic}.
Multiple experiments were designed based on each dataset generated by the respective DA methods (Table \ref{table:training_performance}). For each resulting balanced dataset, a deep learning model was trained via a transfer learning strategy using the pre-trained AlexNet model. The training process involved 20 epochs, a mini-batch size of 8, and an initial learning rate of 0.00005 and the Adam optimization algorithm. The training and validation performance scores for selected experiments are illustrated in Figure~\ref{fig:da_training}. The trained models were subsequently evaluated using the original unbalanced dataset of 6,145 events, with the results presented in Table~\ref{table:testing_real_dataset}. Additionally, confusion matrices for selected experiments are depicted in Figure~\ref{fig:da_confusion_matrix}.

\subsection{Real}
\noindent The original unbalanced dataset, comprising 6,145 events, was utilized, divided into proportions of 80\% for training and 20\% for testing the model. This experiment aims to highlight the influence of an unbalanced dataset on the accuracy of the probabilistic model.
\subsection{Rotation}
\noindent The original unbalanced dataset of 6,145 events has been considered and subsequently balanced using rotation as a data augmentation technique. This approach increases the number of examples from underrepresented classes, resulting in a balanced dataset of 13,430 events. This dataset will demonstrate the effectiveness of this data augmentation technique in constructing a classification model.
...
\noindent The original unbalanced dataset, comprising 6,145 events, was utilized, and data augmentation techniques were applied to achieve balance by increasing the number of examples from underrepresented classes. This process resulted in a balanced dataset of 13,430 events.
The parameters employed include Gaussian noise, distributed as \(N(\mu=0,\sigma=0.2)\). Additionally, a balanced dataset of 13,430 events was generated entirely from augmented data.
\subsection{Drifting}
\noindent The original unbalanced dataset of 6,145 events was considered, and the data augmentation technique was applied in a manner that balanced the dataset by increasing examples from underrepresented classes, yielding a total of 13,430 events.
...
\centering
\footnotesize
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/cae.png}}
...
\begin{figure*}[!t]
\centering
{\includegraphics[width=1.00\textwidth,keepaspectratio]{img/curvas_entrenamiento.png}}
\caption{Training and validation performance scores using transfer learning with AlexNet. Loss and accuracy in training and testing of the experiment on the dataset: a) Drifting Drift(0.001-0.01)(Real+Augmented)(viii), b) Drifting Drift(0.001-0.01)(Augmented)(ix), c) SpecAugment Frequency Percent(0\%-10\%) Frequency Masks(2) Time Percent(0\%-10\%) Time Marks(2)(Augmented)(xxi), and d) Interpolation AE Signal Percent(40\%-60\%)(Augmented)(xxv).}
\label{fig:da_training}
\end{figure*}

\begin{figure*}[!t]
\centering
{\includegraphics[width=1.00\textwidth,keepaspectratio]{img/matriz_confusion.png}}
\caption{Normalized and non-normalized confusion matrix of model training using transfer learning with AlexNet on the dataset: a) Drifting Drift(0.001-0.01)(Real+Augmented)(viii), b) Drifting Drift(0.001-0.01)(Augmented)(ix), c) SpecAugment Frequency Percent(0\%-10\%) Frequency Masks(2) Time Percent(0\%-10\%) Time Marks(2)(Augmented)(xxi), and d) Interpolation AE Signal Percent(40\%-60\%)(Augmented)(xxv).}
...
\subsection{Diversity and Similarity Metrics}
\noindent The diversity and similarity metrics are calculated by comparing two datasets and the same event type. This metric is called an \textit{internal} diversity and similarity metric if only the internal data of the dataset are considered for the comparison(Table \ref{table:internal_similarity_diversity_metrics}). Depending on the dataset type, the following cases apply:
\begin{itemize}
\item \textit{Real + augmented:} Since the VT event has sufficient examples and does not require augmented data to balance the dataset, this metric is not calculated for this specific event due to the lack of comparison data. For the other events, the comparison is made between real and augmented data.
\item \textit{Augmented:} Since all data is augmented, it is divided into two distinct subsets. The subsequent analysis and comparison are then conducted between these two resulting subsets.
\end{itemize}
It is called an \textit{external} diversity and similarity metric if the comparison is made between two datasets, event by event. The datasets considered for this comparison are the study dataset and the real dataset (Table \ref{table:external_similarity_diversity_metrics}).

\subsection{Performace Score}
\noindent By generating a simple score that accounts for model training accuracy (higher value is better), model test accuracy on real data (higher value is better), and the MS-SSIM metric value (lower value is better, indicating greater diversity), we define the Performance Score ($PS$) as follows:
\begin{equation}
\label{eq_ps}
PS = \frac{A_{tr}+2\cdot A_{te}+(1 - MS\text{-}SSIM)}{4}
\end{equation}
where $A_{tr}$ is the model training accuracy, $A_{te}$ is the model test accuracy on real data, and $MS\text{-}SSIM$ is the metric value. All components, $A_{tr}$, $A_{te}$ and $MS\text{-}SSIM$, are defined within the range $\left[0, 1\right]$. The model test accuracy ($A_{te}$) was assigned a higher weight (2x) due to its direct relationship with the model's generalization ability. For the calculation of this score, the \textit{external} MS-SSIM metric was selected because it considers the entire real dataset for its computation.


\begin{table*}
\caption{Relationship between Data Augmentation technique and Dataset.}
\centering
\begin{tabular}{clcc}
\hline\hline
  \multirow{2}{*}{Code} & \multirow{2}{*}{Data augmentation technique} & \multicolumn{2}{c}{ Datasets } \\
  \cline{3-4}
 &  & 
  Real + Augmented
   & 
...
\hline\hline %inserts double horizontal lines
Dataset & Data augmentation technique & {Fréchet Inception Distance\\(FID)
...
\end{tblr}
\end{adjustbox}
\label{table:internal_similarity_diversity_metrics}
\end{table*}

\begin{table*}
\caption{External Similarity and Diversity metrics for experimental datasets.}
\centering
\begin{adjustbox}{width=\textwidth}
\begin{tblr}{
  row{2} = {c}, cell{1}{1} = {r=2}{}, cell{1}{2} = {r=2}{}, cell{1}{3} = {c=6}{c}, cell{3}{1} = {c}, cell{3}{3} = {c}, cell{3}{4} = {c}, cell{3}{5} = {c}, cell{3}{6} = {c}, cell{3}{7} = {c}, cell{3}{8} = {c}, cell{4}{1} = {c},
  cell{4}{3} = {c}, cell{4}{4} = {c}, cell{4}{5} = {c}, cell{4}{6} = {c}, cell{4}{7} = {c}, cell{4}{8} = {c}, cell{5}{1} = {c}, cell{5}{3} = {c}, cell{5}{4} = {c}, cell{5}{5} = {c}, cell{5}{6} = {c}, cell{5}{7} = {c},
  cell{5}{8} = {c}, cell{6}{1} = {c}, cell{6}{3} = {c}, cell{6}{4} = {c}, cell{6}{5} = {c}, cell{6}{6} = {c}, cell{6}{7} = {c}, cell{6}{8} = {c}, cell{7}{1} = {c}, cell{7}{3} = {c}, cell{7}{4} = {c}, cell{7}{5} = {c},
  cell{7}{6} = {c}, cell{7}{7} = {c}, cell{7}{8} = {c}, cell{8}{1} = {c}, cell{8}{3} = {c}, cell{8}{4} = {c}, cell{8}{5} = {c}, cell{8}{6} = {c}, cell{8}{7} = {c}, cell{8}{8} = {c}, cell{9}{1} = {c}, cell{9}{3} = {c},
  cell{9}{4} = {c}, cell{9}{5} = {c}, cell{9}{6} = {c}, cell{9}{7} = {c}, cell{9}{8} = {c}, cell{10}{1} = {c}, cell{10}{3} = {c}, cell{10}{4} = {c}, cell{10}{5} = {c}, cell{10}{6} = {c}, cell{10}{7} = {c}, cell{10}{8} = {c},
  cell{11}{1} = {c}, cell{11}{3} = {c}, cell{11}{4} = {c}, cell{11}{5} = {c}, cell{11}{6} = {c}, cell{11}{7} = {c}, cell{11}{8} = {c}, cell{12}{1} = {c}, cell{12}{3} = {c}, cell{12}{4} = {c}, cell{12}{5} = {c}, cell{12}{6} = {c},
  cell{12}{7} = {c}, cell{12}{8} = {c}, cell{13}{1} = {c}, cell{13}{3} = {c},  cell{13}{4} = {c}, cell{13}{5} = {c}, cell{13}{6} = {c}, cell{13}{7} = {c}, cell{13}{8} = {c}, cell{14}{1} = {c}, cell{14}{3} = {c}, cell{14}{4} = {c},
  cell{14}{5} = {c}, cell{14}{6} = {c}, cell{14}{7} = {c}, cell{14}{8} = {c}, cell{15}{1} = {c}, cell{15}{3} = {c}, cell{15}{4} = {c}, cell{15}{5} = {c}, cell{15}{6} = {c}, cell{15}{7} = {c}, cell{15}{8} = {c}, cell{16}{1} = {c},
  cell{16}{3} = {c}, cell{16}{4} = {c}, cell{16}{5} = {c}, cell{16}{6} = {c}, cell{16}{7} = {c}, cell{16}{8} = {c}, cell{17}{1} = {c}, cell{17}{3} = {c}, cell{17}{4} = {c}, cell{17}{5} = {c}, cell{17}{6} = {c}, cell{17}{7} = {c},
  cell{17}{8} = {c}, cell{18}{1} = {c}, cell{18}{3} = {c}, cell{18}{4} = {c}, cell{18}{5} = {c}, cell{18}{6} = {c}, cell{18}{7} = {c}, cell{18}{8} = {c}, cell{19}{1} = {c}, cell{19}{3} = {c}, cell{19}{4} = {c}, cell{19}{5} = {c},
  cell{19}{6} = {c}, cell{19}{7} = {c}, cell{19}{8} = {c}, cell{20}{1} = {c}, cell{20}{3} = {c}, cell{20}{4} = {c}, cell{20}{5} = {c}, cell{20}{6} = {c}, cell{20}{7} = {c}, cell{20}{8} = {c}, cell{21}{1} = {c}, cell{21}{3} = {c},
  cell{21}{4} = {c}, cell{21}{5} = {c}, cell{21}{6} = {c}, cell{21}{7} = {c}, cell{21}{8} = {c}, cell{22}{1} = {c}, cell{22}{3} = {c}, cell{22}{4} = {c}, cell{22}{5} = {c}, cell{22}{6} = {c}, cell{22}{7} = {c}, cell{22}{8} = {c},
  cell{23}{1} = {c}, cell{23}{3} = {c}, cell{23}{4} = {c}, cell{23}{5} = {c}, cell{23}{6} = {c}, cell{23}{7} = {c}, cell{23}{8} = {c}, cell{24}{1} = {c}, cell{24}{3} = {c}, cell{24}{4} = {c}, cell{24}{5} = {c}, cell{24}{6} = {c},
  cell{24}{7} = {c}, cell{24}{8} = {c}, cell{25}{1} = {c}, cell{25}{3} = {c}, cell{25}{4} = {c}, cell{25}{5} = {c}, cell{25}{6} = {c}, cell{25}{7} = {c}, cell{25}{8} = {c}, cell{26}{1} = {c}, cell{26}{3} = {c}, cell{26}{4} = {c},
  cell{26}{5} = {c}, cell{26}{6} = {c}, cell{26}{7} = {c}, cell{26}{8} = {c}, cell{27}{1} = {c}, cell{27}{3} = {c}, cell{27}{4} = {c}, cell{27}{5} = {c}, cell{27}{6} = {c}, cell{27}{7} = {c}, cell{27}{8} = {c},
}
\hline\hline
Dataset & Data augmentation technique & Multiscale
  Structural Similarity Index (MS-SSIM) &  &  &  &  & \\
\hline  
 &  & HY & LP & TC & TR & VT & MS-SSIM\\
\hline
i & No & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00\\
ii & Rotation(5\%-25\%) & 0.37 & 0.41 & 0.33 & 0.32 & 1.00 & 0.53\\
iii & Rotation(5\%-25\%) & 0.39 & 0.41 & 0.34 & 0.32 & 0.37 & 0.37\\
iv & Jittering(0.2) & 0.26 & 0.37 & 0.32 & 0.25 & 1.00 & 0.49\\
v & Jittering(0.2) & 0.30 & 0.34 & 0.27 & 0.24 & 0.26 & 0.28\\
vi & Drifting Drift(0.01-0.1) & 0.44 & 0.45 & 0.34 & 0.33 & 1.00 & 0.55\\
vii & Drifting Drift(0.01-0.1) & 0.44 & 0.47 & 0.39 & 0.34 & 0.38 & 0.40\\
viii & Drifting Drift(0.001-0.01) & 0.38 & 0.42 & 0.33 & 0.30 & 1.00 & 0.53\\
ix & Drifting
  Drift(0.001-0.01) & 0.36 & 0.43 & 0.35 & 0.31 & 0.33 & 0.35\\
x & Drifting Drift(0.0001-0.001) & 0.38 & 0.41 & 0.33 & 0.29 & 1.00 & 0.53\\
xi & Drifting
  Drift(0.0001-0.001) & 0.32 & 0.40 & 0.33 & 0.30 & 0.35 & 0.34\\
xii & Genetic Algorithm Segment
  Size(5s) Crossover Segments(3) & 0.43 & 0.41 & 0.33 & 0.30 & 1.00 & 0.54\\
xiii & Genetic
  Algorithm Segment Size(5s) Crossover Segments(3) & 0.37 & 0.40 & 0.32 & 0.30 & 0.35 & 0.35\\
xiv & Genetic Algorithm Segment
  Size(5s) Crossover Segments(5) & 0.36 & 0.40 & 0.33 & 0.30 & 1.00 & 0.52\\
xv & Genetic Algorithm
  Segment Size(5s) Crossover Segments(5) & 0.40 & 0.40 & 0.34 & 0.28 & 0.38 & 0.36\\
xvi & Genetic Algorithm Signal Percent(40\%) Crossover
  Segments(10) & 0.35 & 0.40 & 0.32 & 0.30 & 1.00 & 0.52\\
xvii & Genetic Algorithm
  Signal Percent(40\%) Crossover Segments(10) & 0.37 & 0.40 & 0.33 & 0.30 & 0.34 & 0.34\\
xviii & Genetic Algorithm Signal Percent(45\%) Crossover
  Segments(10) & 0.36 & 0.40 & 0.33 & 0.29 & 1.00 & 0.52\\
xix & Genetic Algorithm
  Signal Percent(45\%) Crossover Segments(10) & 0.32 & 0.41 & 0.33 & 0.30 & 0.35 & 0.34\\
xx & SpecAugment Frequency Percent(0\%-10\%) Frequency
  Masks(2) Time Percent(0\%-10\%) Time Marks(2) & 0.39 & 0.40 & 0.34 & 0.30 & 1.00 & 0.53\\
xxi & SpecAugment
  Frequency Percent(0\%-10\%) Frequency Masks(2) Time Percent(0\%-10\%) Time
  Marks(2) & 0.38 & 0.40 & 0.33 & 0.29 & 0.35 & 0.35\\
xxii & SpecAugment Frequency Percent(0\%-15\%) Frequency
  Masks(2) Time Percent(0\%-15\%) Time Marks(2) & 0.35 & 0.41 & 0.33 & 0.31 & 1.00 & 0.53\\
xxiii & SpecAugment
  Frequency Percent(0\%-15\%) Frequency Masks(2) Time Percent(0\%-15\%) Time
  Marks(2) & 0.36 & 0.40 & 0.34 & 0.31 & 0.37 & 0.36\\
xxiv & Interpolation
  AE Signal percent(40\%-60\%) & 0.37 & 0.44 & 0.34 & 0.32 & 1.00 & 0.54\\
xxv & Interpolation AE Signal percent(40\%-60\%) & 0.37 & 0.44 & 0.35 & 0.33 & 0.39 & 0.38\\
\hline
\end{tblr}
\end{adjustbox}
\label{table:external_similarity_diversity_metrics}
\end{table*}


\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/entrenamiento_prueba.png}}
\caption{Accuracy of model training and testing on real data. The \textcolor{dotgreen}{green} shape indicates real dataset with 62.8\% of accuracy (which is not visible because the segment with accuracy$\ge$82\% is displayed), \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.}
\label{fig:da_training_test}
\end{figure}

\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/entrenamiento_msssim_interno.png}}
\caption{Accuracy of model training and internal MS-SSIM metric. The \textcolor{dotgreen}{green} shape indicates real dataset, \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.
}
\label{fig:da_training_msssim_interno}
\end{figure}

\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/entrenamiento_msssim_interno_zoom.png}}
\caption{Zooming at figure of model training accuracy and internal MS-SSIM metric. The \textcolor{dotgreen}{green} shape indicates real dataset with 62.8\% of accuracy (which is not visible because the segment with accuracy$\ge$82\% is displayed), \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.}
\label{fig:da_training_msssim_interno_zoom}
\end{figure}

\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/prueba_msssim_interno.png}}
\caption{Accuracy of model testing and internal MS-SSIM metric. The \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.}
\label{fig:da_test_msssim_interno}
\end{figure}

\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/entrenamiento_msssim_externo.png}}
\caption{Accuracy of model training and external MS-SSIM metric. The \textcolor{dotgreen}{green} shape indicates real dataset, \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.
}
\label{fig:da_training_msssim_externo}
\end{figure}

\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/entrenamiento_msssim_externo_zoom.png}}
\caption{Zooming at figure of model training accuracy and external MS-SSIM metric. The \textcolor{dotgreen}{green} shape indicates real dataset with 62.8\% of accuracy (which is not visible because the segment with accuracy$\ge$80\% is displayed), \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.}
\label{fig:da_training_msssim_externo_zoom}
\end{figure}

\begin{figure}[!t]
\centering
{\includegraphics[width=0.49\textwidth,keepaspectratio]{img/prueba_msssim_externo.png}}
\caption{Accuracy of model testing and external MS-SSIM metric. The \textcolor{dotred}{red} circles indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} squares are entirely augmented datasets. The codes are described in Table~\ref{table:code_dataset}.}
\label{fig:da_test_msssim_externo}
\end{figure}

\begin{figure*}[!t]
\centering
{\includegraphics[width=0.8\textwidth,keepaspectratio]{img/relation_index.png}}
\caption{Performance Score (PS) values on the different datasets (higher is better). The \textcolor{dotgreen}{green} bar indicates real dataset, the \textcolor{dotred}{red} bars indicate datasets with real and augmented data, and \textcolor{dotsky}{turquoise} bars indicate datasets with only augmented data. The codes are described in Table~\ref{table:code_dataset}.}
\label{fig:relation_index}
\end{figure*}


\section{Discussion}\label{discussion}
\noindent The various experiments conducted in this research highlight the performance of the probabilistic model on unbalanced datasets. Specifically, Real dataset (i) produced a model biased toward the LP, TC, and VT events, as shown in Table~\ref{table:training_performance}.
...
In tables \ref{table:training_performance} and \ref{table:testing_real_dataset}, it is evident that the Drifting data augmentation technique achieved the best results across almost all pre-trained models. This success may be attributed to the Drifting technique's ability to effectively cover the data space. The most notable result is from Drifting (Augmented)(xi), which, with a drift range of 0.0001-0.001, achieved an accuracy of 97.6\% over an entirely augmented dataset. An additional noteworthy result is the Rotation (Augmented)(iii) technique, which, with a range of 5\%-25\%, achieved an accuracy of 94.2\% on another augmented dataset.
In both cases, the F1 score metrics closely correspond to their respective accuracies. Although both models were derived from entirely augmented data, they also performed well in real data tests, achieving accuracies of 97.2\% for Drifting (Augmented)(xi) and 93.7\% for Rotation (Augmented)(iii) (Table \ref{table:testing_real_dataset}). However, in tests on real data, the Drifting (Real+Augmented)(x) model achieved the highest accuracy (98.3\%), using both real and augmented data. Furthermore, this dataset (Real+Augmented)(x), generated by Drifting in the range of 0.0001 to 0.001, achieved an accuracy of 93.8\% during model training. Then the dataset of augmented data (ix) generated by Drifting in the range 0.001-0.01, reached an accuracy of 93.5\%. Then we have the augmented data dataset (xxv) generated by Autoencoder Interpolation in the range 40\%-60\%, it obtained an accuracy of 93.1\% (Table \ref{table:training_performance}). These models also show good performance in tests with real data, with accuracies of 98.3\% for Drifting (Real+Augmented)(x), 93.7\% for Drifting (Augmented)(ix) and 80.7\% for Interpolation (Augmented)(xxv) (Table \ref{table:testing_real_dataset}). Only the last Interpolation model (Augmented)(xxv) has a large gap between training and test accuracy on real data.
To obtain a generalized dataset, data from several stations was considered to generate a multi-station generalized probabilistic model. Furthermore, it was observed that models trained with completely augmented data achieved high recognition accuracy with real data in most cases (Table \ref{table:testing_real_dataset}).
...
Regarding the similarity and diversity metrics, initially in the \textit{internal} MS-SSIM, it can be seen that the values for the Rotation and Drifting techniques are similar, although the former shows more diversity, depending on the generation parameters (Table \ref{table:internal_similarity_diversity_metrics}).
It can also be observed that Jittering exhibits higher diversity in datasets (Augmented)(v) and (Real+Augmented)(iv), with MS-SSIM values of 0.26 and 0.29, respectively.
The dataset with the highest similarity and lowest diversity is Drifting (0.01-0.1)(Augmented)(vii), which has an MS-SSIM index of 0.78. This is followed by Interpolation (Augmented)(xxv) and Drifting (Real+Augmented)(vi), with MS-SSIM values of 0.42 and 0.41, respectively.
Figure \ref{fig:da_training_msssim_interno} illustrates the concentration of points representing the MS-SSIM similarity metric versus the accuracy of model training. Notably, two distant points are evident: the dataset comprising only real data (i), which has low accuracy due to being unbalanced, and the Drifting dataset (Augmented)(vii) with a range of 0.01-0.1, which shows higher similarity. Zooming in on this in Figure~\ref{fig:da_training_msssim_interno_zoom}, it is clear that almost all datasets demonstrate similar levels of diversity, including the real dataset; however, the augmented Jittering dataset (v) shows greater diversity.
When comparing datasets composed only of augmented data with those containing both real and augmented data (using the same data augmentation method), the former, in addition to presenting greater or similar diversity, lead to superior training performance, especially with Jittering (Augmented)(v), SpecAugment (Augmented)(xxi) and Rotation (Augmented)(iii).
In Figure~\ref{fig:da_test_msssim_interno}, certain augmented and real datasets demonstrate better diversity and testing accuracy values compared to their counterparts within the same DA method. Notable examples include Drifting (x, xi), Rotation (ii, iii), and SpecAugment (xxii, xxiii).\\

Regarding the \textit{external} similarity and diversity metrics, Table~\ref{table:external_similarity_diversity_metrics} shows that the Real dataset exhibits perfect similarity (Figure~\ref{fig:da_training_msssim_externo}). This result is expected since the dataset is being compared against itself.
Figure \ref{fig:da_training_msssim_externo_zoom} illustrates the distribution of points according to the MS-SSIM metric plotted against the model's training accuracy. The point corresponding to the Real dataset (i) is noticeable, displaying low accuracy due to its imbalance and perfect similarity. Two distinct groups are also observable:
\begin{itemize}
\item The first group comprises datasets that combine real and augmented data, exhibiting MS-SSIM values in the range of 0.5 to 0.55. Two cases fall outside of this range: the Drifting dataset (Real+Augmented)(vi), which shows the greatest similarity with an MS-SSIM value of 0.552, and the Jittering dataset (Real+Augmented)(iv), which shows the greatest diversity for this group, with a value of 0.49.
\item The second group corresponds to the fully augmented datasets, which demonstrate greater diversity than the first group. The MS-SSIM value for this group ranges from 0.3 to 0.4. Two cases fall outside this range: the Drifting dataset (Augmented)(vii), with an MS-SSIM value of 0.401, representing the least diversity within the group, and the Jittering dataset (Augmented)(v), with a value of 0.28, which shows the greatest diversity in this group and overall.
\end{itemize}
In Figure~\ref{fig:da_test_msssim_externo}, a similar configuration of two groups is observed, with one group being more concentrated than the other. The most compact group corresponds to the real and augmented datasets, which exhibit less diversity than the second group.\\

Regarding model performance, the Performance Score (PS), which incorporates the model training accuracy, the model testing accuracy on real data, and the MS-SSIM metric, should be examined. Figure \ref{fig:relation_index} shows that models trained on the Drifting (Augmented)(xi), Jittering (Augmented)(v), SpecAugment (Augmented)(xxi), and Drifting (Augmented)(ix) fully augmented datasets exhibit the highest PS values, making them the most relevant in terms of the trade-off between model accuracy and dataset diversity. In contrast, models with low PS values, such as the Drifting fully augmented dataset (Augmented)(vii) and the real event dataset (i), are negatively impacted by their lower diversity and imbalanced nature, respectively. This analysis conclusively demonstrates the extent to which data augmentation techniques and the inherent diversity of the dataset contributes to model performance.
...
\noindent In this work, several data augmentation techniques are applied to the classification of seismic-volcanic signals. Initially, these techniques were employed to balance the datasets and subsequently to generate fully augmented datasets. Deep learning classification models were then trained on these datasets, utilizing transfer learning with the pre-trained AlexNet model.
...
It was observed that the trained classification models, in conjunction with the considered data augmentation methods, are competitive with the baselines presented in previous research. Additionally, the following results were achieved:
\begin{itemize}
\item The integration of data from multiple stations on the Lascar volcano facilitated the construction of more generalizable probabilistic models, thereby mitigating biases associated with individual stations through various data augmentation techniques.
...
\item The presented data augmentation techniques generate data with greater diversity, and in several cases, models with better performance.
\item Transfer learning significantly accelerated the generation of deep learning models compared to training from scratch.
\end{itemize}
The findings of this work can be used to improve the performance of deep learning models in seismic-volcanic signal recognition, considering the data augmentation techniques presented. Furthermore, the results indicate that models trained exclusively on augmented datasets show excellent performance when tested with real data, in addition to exhibiting diversity. This finding represents a substantial contribution to seismic-volcanic signal recognition.
A repository is available on GitHub for data verification at: \href{https://github.com/franznet/daseismicsignals}{https://github.com/franznet/daseismicsignals}.


\section{Future Work}\label{future_work}
\noindent Future research could focus on optimizing the parameters of existing data augmentation methods to improve model performance. Furthermore, evaluating the effectiveness of these techniques on different types of seismic events and with varying levels of noise would provide deeper insight into their applicability. \\
The Performance Score was calculated based on three components: the model training accuracy, the model test accuracy on real data, and the MS-SSIM diversity of the dataset. In our initial calculation (Eq. \ref{eq_ps}), specific constants were defined to facilitate model comparison. However, a hyperparameter could be incorporated to appropriately weigh these components when calculating the score.\\
To improve model performance, it is essential to quantify the relationship between model accuracy and the diversity generated by the data augmentation method. Specifically, this requires determining the gain in accuracy relative to the variation in dataset diversity.\\
Exploring a methodology to formulate conditions that determine whether a data augmentation technique increases dataset diversity to safe levels without compromising class separation.\\
Integrating these data augmentation strategies with other machine learning approaches, such as ensemble learning or reinforcement learning, could lead to the development of more robust and accurate models for seismic-volcanic signal recognition.\\ 
Finally, a large dataset could be generated using various data augmentation techniques from different channels, stations, and volcanoes.
\\
\\
\\
\textit{Data availability.} The data are registered by \href{https://doi.org/10.5281/Zenodo.6001869}{https://doi.org/10.5281/Zenodo.6001869} (Salazar et al., 2022). These can also be found in the link: \href{https://zenodo.org/record/6001870#.YkGXKffQ-Xl}{https://zenodo.org/record/6001870\#.YkGXKffQ-Xl} (last access: 24 February 2023).
\\
\section*{Acknowledgments}
\noindent We express our acknowledgements to the CKELAR-VOLCANES team.\\
I acknowledge having used Google Gemini (\href{https://gemini.google.com/share/949a14a2c496}{https://gemini.google.com/share/949a14a2c496}) to correct lexical and syntactical errors in the text, as well as to improve the academic tone of this work. The results were used to improve the draft. I used the suggestions to correct some aspects of the text and improve the overall tone of the work.
...
received his Ph.D. degree in Computer Science from the University of Massachusetts, USA. Currently, he is Professor in the Department of Computing and Systems Engineering, Universidad Católica del Norte, Chile. His research interests include Data Mining, Machine Learning, Data Visualization, and Natural Language Processing.
\end{IEEEbiography}
